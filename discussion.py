...
class Messages:
    ...
    RRL="Très bien, amuse-toi bien !"
    RLL="Très bien, amuse-toi bien !"
    RRRR=f"{monstre}"
    RLRR=f"{monstre}"
...
Disscussion.add_message(Messages.RRL,"left",Messages.RR)
Disscussion.add_message(Messages.RLL,"left",Messages.RL)
